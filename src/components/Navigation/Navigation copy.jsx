      ...
      <Nav menuToggle={isOpenMenu}>
        <ul>
          ...
          >
            ...
            {isOpenMenu ? <SubMenu data={articles} category="2" /> : ``}
            {!isOpenMenu && isDropdownVisibleFirst ? (
          ...
          >
            ...
            {isOpenMenu ? <SubMenu data={articles} category="1" /> : ``}
            {!isOpenMenu && isDropdownVisibleSecond ? (
